...
grant select(account,passwd,name,status,lastlanuch,lastIP,times),update(status,lastlanuch,lastIP,times,setting) on simplecs.accounts to 'lanuchUser'@'localhost' identified by 'lanucher';
